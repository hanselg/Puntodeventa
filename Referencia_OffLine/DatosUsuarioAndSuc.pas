...
type
  TfrmDatosUsuarioAndSuc = class(TfrmDatosModule)
    ...
    procedure qrUsuarioSucursalAfterPost(DataSet: TDataSet);
...
procedure TfrmDatosUsuarioAndSuc.qrUsuarioSucursalAfterPost(DataSet: TDataSet);
begin
  inherited;
   BuscarData(cxDBLookupComboBox2.Text);
end;
