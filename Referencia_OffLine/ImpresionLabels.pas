...
type
  TfrmImpresionLabels = class(TForm)
...
var
  frmImpresionLabels: TfrmImpresionLabels;
  Seleccion : string;
...
procedure TfrmImpresionLabels.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if (key = Vk_Down) then
...
procedure TfrmImpresionLabels.Run;
begin
 showmodal;
 ...
 begin
  ...
  begin
   ...
   FrmMain.frmPlanCliente.Imprimir := CbImprimir.Text;
