inherited frmDialogSysDataClientes: TfrmDialogSysDataClientes
  Left = 457
  Top = 236
  ...
  inherited lcDialog: TdxLayoutControl
    ...
    object rgDataSet: TcxRadioGroup [2]
      ...
      Properties.Items = <
        item
          Caption = 'Archivo de Clientes. *.DBF'
        end>
  ...
  object OpenDialog: TOpenDialog
    DefaultExt = '*.dbf'
    FileName = 
      'C:\Archivos de programa\Borland\BDS\4.0\lib\Utileria\Referencia\' +
      'Copia.dbf'
    Filter = 'Tabla DBF|*.dbf'
  ...
  object ADOConnectDbf: TADOConnection
    ConnectionString = 
      'Provider=MSDASQL;Persist Security Info=False;Data Source=dBASE F' +
      'iles'
    Left = 80
    Top = 8
  end
  object Importacion: TADODataSet
    Connection = ADOConnectDbf
    Parameters = <>
    Left = 176
    Top = 8
  end
