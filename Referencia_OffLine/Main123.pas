...
uses DataModule, ActionsDM, DatosModule, CustomModule,
  ...
  DialogCobro,DialogConsultaCliente,DialogConsultaEntradas,DatosClientes,
  ...
  DatosCombos, DialogConsultaPruebasCombos, DatosBanco, DatosDonaciones, DatosTipoDonacion,
  ...
  DialogConsultaReceptorDonacion;
...
//    end;
    ...
    case iOpcion of
     ...
     -7992:with TfrmDialogNC.Create(Self) do begin
              Run;
              Free;
           end;
     ...
     //Banco de sangre
     -6000:with TfrmDialogConsultaPruebasBanco.Create(Self) do begin
              Run;
              Free;
           end;
     -6001:with TfrmDialogConsultaProducto.Create(Self) do begin
              Run;
              Free;
           end;
     -6002:with TfrmDialogConsultaReceptor.Create(Self) do begin
              Run;
              Free;
           end;
     -6003:with TfrmDialogConsultaReceptorDonacion.Create(Self) do begin
              Run;
              Free;
           end;
...
//      end;
      ...
      if CurrentForm is TfrmCustomModule then begin
...
begin
 qfind := DM.NewQuery;
 qfind.Close;
 qfind.SQL.Text := ' SELECT a.*, c.Nombre FROM '+
                   ' PTLabel a,  PTCliente c '+
