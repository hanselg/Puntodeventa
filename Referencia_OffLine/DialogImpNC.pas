  ...
  Begin
    ...
    begin
          ...
          begin
              Close;
              Clear;
              Add('  Select e.NombrePaciente ,e.ClienteNombre, c.ReciboNo , c.EntradaId ,e.Muestrano as Muestrano,'+
                   ' c.Fecha, c.Hora , c.UsuarioID , c.MonedaId ,'+
                   ' p.Empresa as TituloEmpresa, s.Nombre,s.Telefono,isnull(d.Descripcion,'+#39+#39+') as Descripcion, c.PendienteFactura, c.TotalCobrado,'+
                   ...
                   '  Convert(Varchar(200),p.NotaNCreditoBalance) as NotaNCredito, c.TurnoID as Autorizacion, '+
                   '  Convert(Varchar(10),Getdate()+180,120) as Fecha_Autoriza, c.Cobroid as CobroID , c.Refrecid as Refrecid, '+
                   '  p.RNC as RNC, d.Secuencia, p.NotaExterior as SubTituloEmpresa, e.Origen, cd.Devuelta '+
                   ...
                   '   Inner Join ptparametro p on e.DataAreaID=p.DataAreaID '+
