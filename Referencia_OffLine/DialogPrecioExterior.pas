...
uses ActionsDM, DataModule, Main, PuntoVenta, PuntoVentaMod,PuntoVentaND;
...
begin
 If (EdValor.Value > 1) then
   Begin
     ...
     Begin
       frmMain.frmTmpND.qrEntradaPacienteDetallePrecio.Value     := EdValor.Value;
       frmMain.frmTmpND.qrEntradaPacienteDetalleTotalLinea.Value := EdValor.Value;
     end
   end
 Else
