...
//                dm.qrDocumento.Filtered := True;
                ...
                DM.BuscaFoto(frmMain.frmDatPac,Copy(frmMain.frmDatPac.EdCedula.Text,1,3),Copy(frmMain.frmDatPac.EdCedula.Text,5,7),Copy(frmMain.frmDatPac.EdCedula.Text,13,1));
