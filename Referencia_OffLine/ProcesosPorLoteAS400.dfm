object frmProcesosPorLoteAS400: TfrmProcesosPorLoteAS400
  Left = 0
  Top = 0
  Caption = 'Actualizaciones por Lotes al AS400'
  ClientHeight = 167
  ClientWidth = 466
  Color = clBtnFace
  ...
  object qrEntradaPaciente: TADOQuery
    ...
    object qrEntradaPacienteESTATUS_SAP: TStringField
      FieldName = 'ESTATUS_SAP'
      FixedChar = True
      Size = 1
    end
