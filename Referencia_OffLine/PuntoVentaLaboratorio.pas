...
type
  TfrmPuntoVentaLaboratorio = class(TfrmCustomModule)
...
var
  frmPuntoVentaLaboratorio   : TfrmPuntoVentaLaboratorio;
...
function TfrmPuntoVentaLaboratorio.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
begin
...
procedure TfrmPuntoVentaLaboratorio.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
tipoaplica: string; documentoaplica: string;fecha : TDateTime; valor: Double;moneda :string);
var
 qinsert : TADOQuery;
begin
...
procedure TfrmPuntoVentaLaboratorio.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(1402);
end;

procedure TfrmPuntoVentaLaboratorio.CuadredeCaja2Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7987);
end;

procedure TfrmPuntoVentaLaboratorio.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaLaboratorio.ActInterface;
begin
 act_hold;
 Val_Descuento;
...
procedure TfrmPuntoVentaLaboratorio.ImpresionRecibo;
begin
  DM.qrCobro.Close;
...
procedure TfrmPuntoVentaLaboratorio.ImpresionNC;
begin
  DM.qrCobro.Close;
  DM.qrCobro.Parameters[0].Value := cobroid;
  DM.qrCobro.Open;
...
procedure TfrmPuntoVentaLaboratorio.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.CancelarCobro;
begin
...
function TfrmPuntoVentaLaboratorio.GetMuestraNo : String;
begin
  result := GetNextSecDoc('MT');
end;

function TfrmPuntoVentaLaboratorio.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVentaLaboratorio.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;

procedure TfrmPuntoVentaLaboratorio.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
function TfrmPuntoVentaLaboratorio.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLaboratorio.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLaboratorio.TotalDescuentoLinea : Double;
var
...
function TfrmPuntoVentaLaboratorio.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaLaboratorio.CoberturaAplicada : Double;
var
...
procedure TfrmPuntoVentaLaboratorio.CodigodeBarra1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaLaboratorio.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaLaboratorio.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.btclienteClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteCoberturaConfirmada.Value then
...
procedure TfrmPuntoVentaLaboratorio.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.btgrabarClick(Sender: TObject);
var
...
procedure TfrmPuntoVentaLaboratorio.BtHoldClick(Sender: TObject);
begin
 inherited;
  if ValidateRecord(dsEntradaPaciente.DataSet) and ValidateCliente then
   begin
...
procedure TfrmPuntoVentaLaboratorio.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaLaboratorio.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.btpruebaClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-8019);
end;

procedure TfrmPuntoVentaLaboratorio.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmMain.Exis_Lab := False;

  if (qrEntradaPacienteEntredaId.asstring = '') then
      DM.DataBase.Execute('Delete from PTGastosVarioTrans Where Refrecid = '+qrEntradaPacienteRecid.AsString);
end;

procedure TfrmPuntoVentaLaboratorio.FormCreate(Sender: TObject);
begin
  inherited;
  frmMain.Exis_Lab := True;
...
procedure TfrmPuntoVentaLaboratorio.FormDestroy(Sender: TObject);
begin
  inherited;
  frmMain.Exis_Lab := False;
end;

procedure TfrmPuntoVentaLaboratorio.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaLaboratorio.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaLaboratorio.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaLaboratorio.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaLaboratorio.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmPuntoVentaLaboratorio.NuevaVenta;
begin
  cobroid := '';
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteAfterPost(DataSet: TDataSet);
var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
  qrEntradaPacienteTotalPendiente.Value := qrEntradaPacienteNeto.Value - qrEntradaPacienteTotalPagado.Value;
end;

procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
{  if (qrEntradaPacienteCoberturaValor.Value >= 100) and
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
end;

procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
...
procedure TfrmPuntoVentaLaboratorio.VerificarPagoDiferencia;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if qrEntradaPacienteDetalleCoberturaAplica.value then
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
    Begin
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmPuntoVentaLaboratorio.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaLaboratorio.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
  if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) then
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  actinterface;
end;

procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
function TfrmPuntoVentaLaboratorio.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLaboratorio.ActTotales;
Var
 qfind : TADOQuery;
begin
 ActDetalle;
...
procedure TfrmPuntoVentaLaboratorio.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.RecalcularLineas;
begin
...
procedure TfrmPuntoVentaLaboratorio.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPacienteDescuentoPorc.Value := 0;
  qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmPuntoVentaLaboratorio.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaLaboratorio.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLaboratorio.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaLaboratorio.edcoberturavalorExit(Sender: TObject);
begin
  inherited;
  if qrEntradaPaciente.State in [dsedit,dsinsert] then
  begin
...
function TfrmPuntoVentaLaboratorio.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVentaLaboratorio.GastosVarios1Click(Sender: TObject);
begin
  inherited;
  frmMain.lanzaConsulta(-7984,qrEntradaPacienteRecid.asstring);
end;

function TfrmPuntoVentaLaboratorio.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVentaLaboratorio.btcobrarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.CrearCobro;
Var
 qinsert    : TADOQuery;
...
procedure TfrmPuntoVentaLaboratorio.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaLaboratorio.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaLaboratorio.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaLaboratorio.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaLaboratorio.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaLaboratorio.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaLaboratorio.ActNotaCredito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
...
procedure TfrmPuntoVentaLaboratorio.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaLaboratorio.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := recid;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaLaboratorio.RefrescarInterface;
begin
  actinterface;
...
//Validando Los Parametros de Descuentos.
procedure TfrmPuntoVentaLaboratorio.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
...
function TfrmPuntoVentaLaboratorio.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaLaboratorio.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
 qfind := DM.Find('Select * from SysUsuarios Where UserID = :user', DM.CurUser);
...
procedure TfrmPuntoVentaLaboratorio.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
 inherited;
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaLaboratorio.act_hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaLaboratorio.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.Buscar_Muestra;
Var
 qfind  : TADOQuery;
 Dias   : Extended;
begin
...
procedure TfrmPuntoVentaLaboratorio.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaLaboratorio.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaLaboratorio.Insertar_Combo_Blanco;
begin
  While Not qfindcombo.Eof Do
    Begin
      qrEntradaPacienteDetalle.Post;
...
//Actualizando los Datos del Cliente (Poliza - Aseguradora).
procedure TfrmPuntoVentaLaboratorio.Act_Seguro_Cliente;
Var
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaLaboratorio.Buscar_Cliente;
begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaLaboratorio.Buscar_Paciente;
begin
...
procedure TfrmPuntoVentaLaboratorio.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVentaLaboratorio.Insert_Card_Descuento;
...
procedure TfrmPuntoVentaLaboratorio.ppHeaderBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  inherited;
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaLaboratorio.ppDetailBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaLaboratorio.ppDetailBand5BeforePrint(Sender: TObject);
begin
  inherited;
