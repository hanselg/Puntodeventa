    ...
    if (Confirmado = 1) then
     Begin
      If ((frmMain.frmTmpND.qrEntradaPacienteClienteID.Value = 'C00075') Or
         ...
         (frmMain.frmTmpND.qrEntradaPacienteClienteID.Value = 'C01673')) And (Copy(frmMain.frmTmpND.qrEntradaPacienteAprobacionNo.Value,1,1)<>'P') Then
          frmMain.frmTmpND.qrEntradaPacienteAprobacionNo.Value  := 'P'+EdAprobacionNo.EditingText;
      If ((frmMain.frmTmpND.qrEntradaPacienteClienteID.Value ='C03103') Or
         (frmMain.frmTmpND.qrEntradaPacienteClienteID.Value ='C03209'))  And (Copy(frmMain.frmTmpND.qrEntradaPacienteAprobacionNo.Value,1,1)<>'H') Then
          frmMain.frmTmpND.qrEntradaPacienteAprobacionNo.Value  := 'H'+EdAprobacionNo.EditingText;
