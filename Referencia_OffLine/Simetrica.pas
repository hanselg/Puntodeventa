...
// WSDL     : http://localhost:40643/Simetrica.asmx?WSDL
// Encoding : utf-8
// Version  : 1.0
// (29/04/2016 03:51:35 p.m. - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  // service   : Simetrica
  // port      : SimetricaSoap
  // URL       : http://localhost:40643/Simetrica.asmx
  // ************************************************************************ //
  SimetricaSoap = interface(IInvokable)
  ['{52328E1E-9500-6F42-74DB-59D16830C37B}']
    function  ValidaAfiliado(const codArs: Integer; const codAfiliado: Int64; const codProveedor: Int64): AfiliadoSM; stdcall;
    function  CotizacionPorCoberturas(const codArs: Integer; const coberturas: ArrayOfCoberturaSM; const codAfiliado: Int64; const codProveedor: Int64): CotizacionSM; stdcall;
    function  ReclamacionPorCoberturas(const codArs: Integer; const coberturas: ArrayOfCoberturaSM; const codAfiliado: Int64; const codProveedor: Int64): ReclamacionSM; stdcall;
    function  CancelarAutorizacion(const codArs: Integer; const codSession: Int64): CancelacionSM; stdcall;
  end;
...
const
  defWSDL = 'http://localhost:40643/Simetrica.asmx?WSDL';
  defURL  = 'http://localhost:40643/Simetrica.asmx';
  defSvc  = 'Simetrica';
