...
//                                          ' Sólo puede facturarlo como privado.', []);
          ...
          begin
            ...
            begin
               If Length(Trim(frmMain.frmTmp.qrEntradaPacienteDireccion.AsString)) > 80 then  frmMain.frmTmp.cxDbMemo2.Style.Color  := ClYellow;
        ...
        begin
           ...
           begin
               If Length(Trim(frmMain.frmTmpMod.qrEntradaPacienteDireccion.AsString)) > 80 then  frmMain.frmTmpMod.cxDbMemo2.Style.Color  := ClYellow;
        ...
        begin
           ...
           begin
               If Length(Trim(frmMain.frmTmpND.qrEntradaPacienteDireccion.AsString)) > 80 then  frmMain.frmTmpND.cxDbMemo2.Style.Color  := ClYellow;
