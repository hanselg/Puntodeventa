     ...
     Begin
{
       ...
       If (Verifica_Pruebas_CargoUSA) And (qrPruebas.FieldByName('permitecambioprecio').Asinteger = 0) Then
       begin
       ...
       begin
         If ((dm.TotalPruebas_USA) = 1) And (Not (qrPruebas.Locate('PruebaID','SER00596',[]))) then
         begin
              Raise exception.CreateFmt(' USA CARGO ADICIONAL NO correcto. Favor verifique número de pruebas USA.', []);
         end
         else
         If ((dm.TotalPruebas_USA) = 2) And (Not (qrPruebas.Locate('PruebaID','SER00597',[]))) then
         begin
              Raise exception.CreateFmt(' USA CARGO ADICIONAL NO correcto. Favor verifique número de pruebas USA.', []);
         end
         else
         If ((dm.TotalPruebas_USA) >= 3) And (Not (qrPruebas.Locate('PruebaID','SER00598',[]))) then
         begin
              Raise exception.CreateFmt(' USA CARGO ADICIONAL NO correcto. Favor verifique número de pruebas USA.', []);
         end;
       end;
...
begin
  ...
  Result:=false;
    if Factura_St = 'I' Then
    begin
        if frmMain.frmTmp.qrEntradaPacienteDetalle.Locate('PruebaID','SER00596',[]) Or
           frmMain.frmTmp.qrEntradaPacienteDetalle.Locate('PruebaID','SER00597',[]) Or
           frmMain.frmTmp.qrEntradaPacienteDetalle.Locate('PruebaID','SER00598',[]) then
           Result:=true
    end else if Factura_St = 'M' Then
    begin
        if frmMain.frmTmpMod.qrEntradaPacienteDetalle.Locate('PruebaID','SER00596',[]) Or
           frmMain.frmTmpMod.qrEntradaPacienteDetalle.Locate('PruebaID','SER00597',[]) Or
           frmMain.frmTmpMod.qrEntradaPacienteDetalle.Locate('PruebaID','SER00598',[]) then
           Result:=true
    end else if Factura_St = 'L' Then
    begin
        if frmMain.frmTmpLab.qrEntradaPacienteDetalle.Locate('PruebaID','SER00596',[]) Or
           frmMain.frmTmpLab.qrEntradaPacienteDetalle.Locate('PruebaID','SER00597',[]) Or
           frmMain.frmTmpLab.qrEntradaPacienteDetalle.Locate('PruebaID','SER00598',[]) then
           Result:=true
    end else if Factura_St = 'C' Then
    begin
        if frmMain.frmClinica.qrEntradaPacienteDetalle.Locate('PruebaID','SER00596',[]) Or
           frmMain.frmClinica.qrEntradaPacienteDetalle.Locate('PruebaID','SER00597',[]) Or
           frmMain.frmClinica.qrEntradaPacienteDetalle.Locate('PruebaID','SER00598',[]) then
           Result:=true
    end else if Factura_St = 'F' Then
    begin
        if frmMain.frmTmpND.qrEntradaPacienteDetalle.Locate('PruebaID','SER00596',[]) Or
           frmMain.frmTmpND.qrEntradaPacienteDetalle.Locate('PruebaID','SER00597',[]) Or
           frmMain.frmTmpND.qrEntradaPacienteDetalle.Locate('PruebaID','SER00598',[]) then
           Result:=true
    end;
End;
