...
type
  TfrmPuntoVenta_OLD = class(TfrmCustomModule)
...
var
  frmPuntoVenta_OLD   : TfrmPuntoVenta_OLD;
...
function TfrmPuntoVenta_OLD.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
begin
...
procedure TfrmPuntoVenta_OLD.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
tipoaplica: string; documentoaplica: string;fecha : TDateTime; valor: Double;moneda :string);
var
 qinsert : TADOQuery;
begin
...
procedure TfrmPuntoVenta_OLD.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(1402);
end;

procedure TfrmPuntoVenta_OLD.CuadredeCaja2Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7987);
end;

procedure TfrmPuntoVenta_OLD.RefrescarGrid(SoloLectura: Boolean);
begin
...
function TfrmPuntoVenta_OLD.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVenta_OLD.ActInterface;
begin
 act_hold;
...
procedure TfrmPuntoVenta_OLD.ImpresionRecibo;
begin
...
procedure TfrmPuntoVenta_OLD.ImpresionNC;
begin
  DM.qrCobro.Close;
  DM.qrCobro.Parameters[0].Value := cobroid;
  DM.qrCobro.Open;
...
procedure TfrmPuntoVenta_OLD.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.CancelarCobro;
begin
...
function TfrmPuntoVenta_OLD.GetMuestraNo : String;
begin
  result := GetNextSecDoc('MT');
end;

function TfrmPuntoVenta_OLD.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVenta_OLD.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;

procedure TfrmPuntoVenta_OLD.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
function TfrmPuntoVenta_OLD.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVenta_OLD.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVenta_OLD.TotalDescuentoLinea : Double;
var
...
function TfrmPuntoVenta_OLD.ImporteLinea : Double;
Var
...
function TfrmPuntoVenta_OLD.CoberturaAplicada : Double;
var
...
procedure TfrmPuntoVenta_OLD.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7993);
end;

procedure TfrmPuntoVenta_OLD.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btcobrarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btclienteClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteCoberturaConfirmada.Value then
...
procedure TfrmPuntoVenta_OLD.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btgrabarClick(Sender: TObject);
var
...
procedure TfrmPuntoVenta_OLD.BtHoldClick(Sender: TObject);
begin
 inherited;
  if ValidateRecord(dsEntradaPaciente.DataSet) and ValidateCliente then
   begin
...
procedure TfrmPuntoVenta_OLD.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVenta_OLD.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btpacienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.btpruebaClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7998);
end;

procedure TfrmPuntoVenta_OLD.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.FormCreate(Sender: TObject);
begin
...
procedure TfrmPuntoVenta_OLD.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVenta_OLD.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVenta_OLD.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVenta_OLD.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVenta_OLD.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmPuntoVenta_OLD.NuevaVenta;
begin
  cobroid := '';
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVenta_OLD.ppHeaderBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteAfterPost(DataSet: TDataSet);
var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
  qrEntradaPacienteTotalPendiente.Value := qrEntradaPacienteNeto.Value - qrEntradaPacienteTotalPagado.Value;
end;

procedure TfrmPuntoVenta_OLD.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
{  if (qrEntradaPacienteCoberturaValor.Value >= 100) and
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
end;

procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
...
procedure TfrmPuntoVenta_OLD.VerificarPagoDiferencia;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if qrEntradaPacienteDetalleCoberturaAplica.value then
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
  ...
  begin
   //Buscando los Datos del Cliente. (Cliente & Parametros).
   Buscar_Cliente;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
    Begin
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteDoctorIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
  if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) then
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  actinterface;
end;

procedure TfrmPuntoVenta_OLD.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
function TfrmPuntoVenta_OLD.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVenta_OLD.MenuItem1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7988);
end;

procedure TfrmPuntoVenta_OLD.ActTotales;
Var
 qfind : TADOQuery;
begin
 ActDetalle;
...
procedure TfrmPuntoVenta_OLD.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.RecalcularLineas;
begin
...
procedure TfrmPuntoVenta_OLD.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7994,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmPuntoVenta_OLD.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPacienteDescuentoPorc.Value := 0;
...
function TfrmPuntoVenta_OLD.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVenta_OLD.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVenta_OLD.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVenta_OLD.edcoberturavalorExit(Sender: TObject);
begin
  inherited;
  if qrEntradaPaciente.State in [dsedit,dsinsert] then
  begin
...
procedure TfrmPuntoVenta_OLD.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
procedure TfrmPuntoVenta_OLD.ActNotaCredito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
...
function TfrmPuntoVenta_OLD.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVenta_OLD.GastosVarios1Click(Sender: TObject);
begin
  inherited;
  frmMain.lanzaConsulta(-7984,qrEntradaPacienteRecid.asstring);
end;

function TfrmPuntoVenta_OLD.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVenta_OLD.CrearCobro;
Var
 qinsert : TADOQuery;
...
procedure TfrmPuntoVenta_OLD.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVenta_OLD.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVenta_OLD.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVenta_OLD.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVenta_OLD.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVenta_OLD.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := recid;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVenta_OLD.RefrescarInterface;
begin
  actinterface;
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVenta_OLD.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
 inherited;
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVenta_OLD.act_hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVenta_OLD.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVenta_OLD.Buscar_Muestra;
Var
 qfind  : TADOQuery;
 Dias   : Extended;
begin
...
procedure TfrmPuntoVenta_OLD.Buscar_Combo;
begin
...
procedure TfrmPuntoVenta_OLD.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVenta_OLD.Insertar_Combo_Blanco;
begin
  While Not qfindcombo.Eof Do
    Begin
      qrEntradaPacienteDetalle.Post;
...
//Actualizando los Datos del Cliente (Poliza - Aseguradora).
procedure TfrmPuntoVenta_OLD.Act_Seguro_Cliente;
Var
...
//Buscando los Datos del Cliente. (Cliente & Parametros).
procedure TfrmPuntoVenta_OLD.Buscar_Cliente;
begin
...
procedure TfrmPuntoVenta_OLD.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVenta_OLD.Insert_Card_Descuento;
Var qfind, qinsert : TAdoQuery;
begin
