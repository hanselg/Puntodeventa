...
type
  TfrmDialogConsultaPruebasPG = class(TfrmDialogConsulta)
...
var
  frmDialogConsultaPruebasPG: TfrmDialogConsultaPruebasPG;
  adentrogrid : Boolean;
...
procedure TfrmDialogConsultaPruebasPG.BuscarData;
var
 sqlString : String;
begin
 ...
 Begin
     ...
     If (frmMain.Exis_Vta = True) Then
       sqlString := sqlString + ' and descripcion like '+'%PERFIL GENETICO%'+' AND LEN(DESCRIPCION)> 15' ;
...
procedure TfrmDialogConsultaPruebasPG.Run;
Var
 qfind : TADOQuery;
begin
 showmodal;
...
procedure TfrmDialogConsultaPruebasPG.cgDatosEnter(Sender: TObject);
begin
  inherited;
  adentrogrid := true;
end;

procedure TfrmDialogConsultaPruebasPG.cgDatosExit(Sender: TObject);
begin
  inherited;
  adentrogrid := false;
end;

procedure TfrmDialogConsultaPruebasPG.edbuscarExit(Sender: TObject);
begin
  inherited;
  BuscarData;
end;

procedure TfrmDialogConsultaPruebasPG.edbuscarPropertiesChange(Sender: TObject);
begin
  inherited;
  BuscarData;
end;

procedure TfrmDialogConsultaPruebasPG.FormCreate(Sender: TObject);
begin
  inherited;
  qrPruebas.Close;
  qrPruebas.Open;
...
procedure TfrmDialogConsultaPruebasPG.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmDialogConsultaPruebasPG.FormShow(Sender: TObject);
begin
  inherited;
  edbuscar.SetFocus;
end;
Function TfrmDialogConsultaPruebasPG.Verifica_Pruebas_Aceptadas: Boolean;
begin
  inherited;
  Result:=false;
    if Factura_St = 'I' Then
...
End;
Function TfrmDialogConsultaPruebasPG.Verifica_Seleccion: Boolean;
begin
  inherited;
  Result:=false;
