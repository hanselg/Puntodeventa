...
type
  TfrmPuntoVentaCaps = class(TfrmCustomModule)
...
var
  frmPuntoVentaCaps   : TfrmPuntoVentaCaps;
...
function TfrmPuntoVentaCaps.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
begin
...
procedure TfrmPuntoVentaCaps.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
tipoaplica: string; documentoaplica: string;fecha : TDateTime; valor: Double;moneda :string);
var
 qinsert : TADOQuery;
begin
...
procedure TfrmPuntoVentaCaps.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaCaps.ActInterface;
begin
 Val_Descuento;
...
procedure TfrmPuntoVentaCaps.ImpresionRecibo;
begin
  DM.qrCobro.Close;
...
procedure TfrmPuntoVentaCaps.ImpresionNC;
begin
  DM.qrCobro.Close;
  DM.qrCobro.Parameters[0].Value := cobroid;
  DM.qrCobro.Open;
...
procedure TfrmPuntoVentaCaps.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.CancelarCobro;
begin
...
function TfrmPuntoVentaCaps.GetMuestraNo : String;
begin
  result := GetNextSecDoc('MT');
end;

function TfrmPuntoVentaCaps.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmPuntoVentaCaps.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;

procedure TfrmPuntoVentaCaps.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
function TfrmPuntoVentaCaps.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaCaps.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaCaps.TotalDescuentoLinea : Double;
var
...
function TfrmPuntoVentaCaps.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaCaps.CoberturaAplicada : Double;
var
...
procedure TfrmPuntoVentaCaps.CodigodeBarra1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaCaps.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaCaps.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.btgrabarClick(Sender: TObject);
var
...
procedure TfrmPuntoVentaCaps.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaCaps.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.btpruebaClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-8018);
end;

procedure TfrmPuntoVentaCaps.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  frmMain.Exis_Cap := False;  
  if (qrEntradaPacienteEntredaId.asstring = '') then
      DM.DataBase.Execute('Delete from PTGastosVarioTrans Where Refrecid = '+qrEntradaPacienteRecid.AsString);
end;

procedure TfrmPuntoVentaCaps.FormCreate(Sender: TObject);
begin
  inherited;
  frmMain.Exis_Cap := True;
...
procedure TfrmPuntoVentaCaps.FormDestroy(Sender: TObject);
begin
  inherited;
  frmMain.Exis_Cap := False;
end;

procedure TfrmPuntoVentaCaps.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaCaps.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaCaps.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaCaps.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaCaps.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmPuntoVentaCaps.NuevaVenta;
Var
 qcliente, qpaciente, qfindciudad: TADOQuery;
begin
  cobroid := '';
  DM.qrParametro.Close;
  DM.qrParametro.Open;
  ...
  qrEntradaPacienteOrigen.Value := '08';
  qrEntradaPacienteTipoEntrada.Value := 'N';
  qrEntradaPacienteTipoDocumento.Value := 4;
  qrEntradaPacienteFormadePago.Value := 'Contado';
  qrEntradaPacienteClienteId.Value := DM.qrParametroClienteCap.Value;
  qrEntradaPacientePacienteId.Value := DM.qrParametroClienteCap.Value;

  qcliente := DM.Find('Select * from PTCliente Where ClienteId = :cli', qrEntradaPacienteClienteId.Value);
  qrEntradaPacienteClienteNombre.Value := qcliente.FieldByName('Nombre').AsString;

  qpaciente := DM.Find('Select * from PTCliente Where ClienteId = :cli', qrEntradaPacienteClienteId.Value);
  qrEntradaPacienteClienteNombre.Value := qcliente.FieldByName('Nombre').AsString;

  qfindciudad := DM.Find('Select * from PTCiudad Where CiudadID = :ciu', qpaciente.FieldByName('CiudadID').AsString);

 qrEntradaPacienteNombrePaciente.Value := qpaciente.FieldByName('Nombre').AsString;
 qrEntradaPacienteDireccion.Value := qpaciente.FieldByName('Direccion').AsString;
 qrEntradaPacienteTelefonos.Value := qpaciente.FieldByName('Telefono').AsString;
 qrEntradaPacienteEmail.Value := qpaciente.FieldByName('EMail').AsString;
 qrEntradaPacienteFax.Value := qpaciente.FieldByName('Fax').AsString;
 qrEntradaPacienteEdadPaciente.Value := trunc((DM.SystemDate - qpaciente.FieldByName('FechaNacimiento').AsDateTime) / 365);
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteAfterPost(DataSet: TDataSet);
var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
  qrEntradaPacienteTotalPendiente.Value := qrEntradaPacienteNeto.Value - qrEntradaPacienteTotalPagado.Value;
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
   if (qrEntradaPacienteCoberturaValor.Value > qrEntradaPacienteSubTotal.Value) then
     raise exception.CreateFmt('El valor de la cobertura no puede ser mayor que el total de la factura.',[]);
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
...
procedure TfrmPuntoVentaCaps.VerificarPagoDiferencia;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if qrEntradaPacienteDetalleCoberturaAplica.value then
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
    Begin
...
procedure TfrmPuntoVentaCaps.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaCaps.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  actinterface;
end;

procedure TfrmPuntoVentaCaps.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
function TfrmPuntoVentaCaps.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaCaps.ActTotales;
Var
 qfind : TADOQuery;
begin
 ActDetalle;
...
procedure TfrmPuntoVentaCaps.RecalcularLineas;
begin
...
function TfrmPuntoVentaCaps.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaCaps.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaCaps.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaCaps.edcoberturavalorExit(Sender: TObject);
begin
  inherited;
  if qrEntradaPaciente.State in [dsedit,dsinsert] then
  begin
...
function TfrmPuntoVentaCaps.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
function TfrmPuntoVentaCaps.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;

 result := GetNextSecDoc('CAP');
end;


procedure TfrmPuntoVentaCaps.btcobrarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.BtConsultarClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.CrearCobro;
Var
 qinsert    : TADOQuery;
...
procedure TfrmPuntoVentaCaps.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaCaps.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaCaps.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaCaps.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaCaps.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaCaps.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaCaps.ActNotaCredito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
...
procedure TfrmPuntoVentaCaps.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
   begin
...
procedure TfrmPuntoVentaCaps.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := recid;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaCaps.RefrescarInterface;
begin
  actinterface;
...
//Validando Los Parametros de Descuentos.
procedure TfrmPuntoVentaCaps.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
...
function TfrmPuntoVentaCaps.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaCaps.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
 qfind := DM.Find('Select * from SysUsuarios Where UserID = :user', DM.CurUser);
...
procedure TfrmPuntoVentaCaps.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.Buscar_Muestra;
Var
 qfind  : TADOQuery;
 Dias   : Extended;
begin
...
procedure TfrmPuntoVentaCaps.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaCaps.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaCaps.Insertar_Combo_Blanco;
begin
  While Not qfindcombo.Eof Do
    Begin
      qrEntradaPacienteDetalle.Post;
...
procedure TfrmPuntoVentaCaps.Act_Seguro_Cliente;
Var
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaCaps.Buscar_Cliente;
begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaCaps.Buscar_Paciente;
begin
...
procedure TfrmPuntoVentaCaps.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
procedure TfrmPuntoVentaCaps.Insert_Card_Descuento;
...
procedure TfrmPuntoVentaCaps.ppHeaderBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  inherited;
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaCaps.ppDetailBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaCaps.ppDetailBand5BeforePrint(Sender: TObject);
begin
  inherited;
