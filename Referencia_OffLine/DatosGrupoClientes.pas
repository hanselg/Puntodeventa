...
uses
  ...
  cxCurrencyEdit, cxMaskEdit, cxSpinEdit, cxMemo, cxintl;
...
type
  TfrmDatosGrupoClientes = class(TfrmDatosModule)
    ...
    qrGrupoClientesDATAAREAID: TStringField;
    qrGrupoClientesSINPRFILTERGROUP: TIntegerField;
    cxDBCurrencyEdit1: TcxDBCurrencyEdit;
    lcDatosItem4: TdxLayoutItem;
    qrGrupoClientesRECID: TLargeintField;
  private
