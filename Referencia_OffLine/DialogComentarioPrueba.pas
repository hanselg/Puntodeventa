...
begin
  ...
  begin
    ...
    begin
       Self.Caption := 'Seleccione '+frmMain.frmTmpND.qrEntradaPacienteDetalleDESCRIPCION.Value;
    end;
  end;
  ...
  begin
    Close;
    Clear;
    Add(' SELECT Cod_Comen+convert(varchar(2),secuencia) as Cod_Comen,Descripcion from PTCOMENTARIOPRUEBAS ');
 ...
 begin
    ...
    begin
       frmMain.frmTmpND.qrEntradaPacienteDetalle.Edit;
       frmMain.frmTmpND.qrEntradaPacienteDetalleComentario.Value  := JvMemoryData1Descripcion.Value;
    end;
 end;
end;
