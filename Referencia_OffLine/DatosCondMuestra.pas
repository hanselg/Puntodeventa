...
type
  TfrmDatosCondMuestra = class(TfrmDatosModule)
    qrCondMuestra: TADOQuery;
    ...
    qrCondMuestraCondMuestra: TStringField;
    qrCondMuestraDescripcion: TStringField;
  private
...
var
  frmDatosCondMuestra: TfrmDatosCondMuestra;
