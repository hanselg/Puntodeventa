...
type
  TfrmPuntoVentaAdministracion = class(TfrmCustomModule)
    ...
    qrEntradaPacienteDetalleCOMENTARIOMUESTRA: TMemoField;
    ...
    qrEntradaPacienteDetalleESTATUS: TIntegerField;
...
var
  frmPuntoVentaAdministracion   : TfrmPuntoVentaAdministracion;
...
function TfrmPuntoVentaAdministracion.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
 suc : Boolean;
...
procedure TfrmPuntoVentaAdministracion.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
tipoaplica: string; documentoaplica: string; fecha : TDateTime; valor: Double; moneda :string);
var
 qinsert : TADOQuery;
begin
...
procedure TfrmPuntoVentaAdministracion.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(1402);
end;

procedure TfrmPuntoVentaAdministracion.CuadredeCaja2Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7987);
end;

procedure TfrmPuntoVentaAdministracion.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmPuntoVentaAdministracion.ActInterface;
begin
 Act_Hold;
 Val_Descuento;
...
procedure TfrmPuntoVentaAdministracion.ImpresionRecibo;
begin
  DM.qrCobro.Close;
...
procedure TfrmPuntoVentaAdministracion.ImpresionNC;
begin
  DM.qrCobro.Close;
  DM.qrCobro.Parameters[0].Value := cobroid;
  DM.qrCobro.Open;
...
procedure TfrmPuntoVentaAdministracion.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.CancelarCobro;
begin
...
function TfrmPuntoVentaAdministracion.GetMuestraNo : String;
Var
 qsecdoc : TADOQuery;
 anio, mes, dia : Word;
begin
...
function TfrmPuntoVentaAdministracion.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;


function TfrmPuntoVentaAdministracion.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;


procedure TfrmPuntoVentaAdministracion.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
 ...
 begin
  ...
  qact.SQL.Text := ' UPDATE PTEntradaPacienteDetalle SET '+
                   ' CoberturaAplicada = :cob, DescuentoLineaAplicado = :desc '+
                   ' WHERE RefRecid = :rec '+
                   ' AND Secuencia = :sec ';
...
function TfrmPuntoVentaAdministracion.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaAdministracion.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaAdministracion.TotalDescuentoLinea : Double;
var
...
function TfrmPuntoVentaAdministracion.ImporteLinea : Double;
Var
...
function TfrmPuntoVentaAdministracion.CoberturaAplicada : Double;
var
...
//        if not qrEntradaPacienteDetalleCoberturaExpPorc.Value then
        if not qrEntradaPacienteDetalleCoberturaExpPorc.AsBoolean then
...
procedure TfrmPuntoVentaAdministracion.CodigodeBarra1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaAdministracion.RegistrarCobrosTemporales1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-8024);
end;

procedure TfrmPuntoVentaAdministracion.RegistrarFechaPrometida1Click(Sender: TObject);
begin
  inherited;
  Showmessage('Pendiente de Toma de Muestra.!!!');
end;

procedure TfrmPuntoVentaAdministracion.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btclienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btgrabarClick(Sender: TObject);
var
...
procedure TfrmPuntoVentaAdministracion.BtHoldClick(Sender: TObject);
begin
 inherited;
  if ValidateRecord(dsEntradaPaciente.DataSet) and ValidateCliente then
   begin
...
procedure TfrmPuntoVentaAdministracion.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaAdministracion.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btpacienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.btpruebaClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.FormDestroy(Sender: TObject);
begin
  if (qrEntradaPacienteEntradaID.asstring = '') then
    begin
      DM.DataBase.Execute('Delete from PTGastosVarioTrans Where Refrecid = '+qrEntradaPacienteRecid.AsString);
...
procedure TfrmPuntoVentaAdministracion.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaAdministracion.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaAdministracion.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmPuntoVentaAdministracion.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmPuntoVentaAdministracion.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmPuntoVentaAdministracion.NuevaVenta;
begin
  Operacion := 'E';
  cobroid := '';
  DM.qrParametro.Close;
 ...
 // edcoberturaporc.Properties.ReadOnly := qrEntradaPacienteCoberturaConfirmada.Value;
  edcobexpporc.Properties.ReadOnly := qrEntradaPacienteCoberturaConfirmada.AsBoolean;
  edcoberturavalor.Properties.ReadOnly := qrEntradaPacienteCoberturaConfirmada.AsBoolean;
  ConfirmarCobertura1.Enabled := not qrEntradaPacienteCoberturaConfirmada.AsBoolean;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteAfterPost(DataSet: TDataSet);
var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
  qrEntradaPacienteTotalPendiente.Value := qrEntradaPacienteNeto.Value - qrEntradaPacienteTotalPagado.Value;
end;

procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteClienteIDChange(Sender: TField);
begin
  inherited;
  If qrEntradaPaciente.State in [dsEdit,dsInsert] then
    ActTotales;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
{
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
end;

procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
...
procedure TfrmPuntoVentaAdministracion.VerificarPagoDiferencia;
var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if ( qrEntradaPacienteDetalleCoberturaAplica.Value = 1) then
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
end;

procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  comboprecio := True;
end;

procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
  ...
  begin
   ...
   If (qrEntradaPacienteFactExterior.Value = 1) then
     Begin
       ...
       qrEntradaPacienteDetalleEstatus.Value := 0; //'0'; //TOMA DE MUESTRA
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
    Begin
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmPuntoVentaAdministracion.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmPuntoVentaAdministracion.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
  if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) then
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  actinterface;
end;

procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.Materiales1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7982,qrEntradaPacienteRecid.AsString);
end;

function TfrmPuntoVentaAdministracion.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaAdministracion.Buscar_Linea: Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaAdministracion.MenuItem1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7988);
end;

procedure TfrmPuntoVentaAdministracion.ActTotales;
Var
 qfind : TADOQuery;
begin
 ActDetalle;
 ...
 qfind.SQL.Text := ' SELECT SUM(Precio), SUM(DescuentoLineaAplicado), SUM(CoberturaAplicada) '+
                   ' FROM PTEntradaPacienteDetalle WHERE refRecid = '+ inttostr(recid);
 qfind.Open;
{
...
procedure TfrmPuntoVentaAdministracion.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.RecalcularLineas;
begin
...
procedure TfrmPuntoVentaAdministracion.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPacienteDescuentoPorc.Value := 0;
  qrEntradaPacienteDescuentoValor.Value := 0;
...
procedure TfrmPuntoVentaAdministracion.EliminarOrdenesenHold1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.MarcarPruebaNOProcesar1Click(Sender: TObject);
begin
  inherited;
  No_Procesar;
end;

function TfrmPuntoVentaAdministracion.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaAdministracion.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaAdministracion.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmPuntoVentaAdministracion.EdCoberturaValorExit(Sender: TObject);
begin
  inherited;
  Act_Cobertura
end;
...
procedure TfrmPuntoVentaAdministracion.Act_Cobertura;
begin
 if qrEntradaPaciente.State in [dsedit, dsinsert] then
  begin
   qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmPuntoVentaAdministracion.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmPuntoVentaAdministracion.GastosVarios1Click(Sender: TObject);
begin
  inherited;
  frmMain.lanzaConsulta(-7984, qrEntradaPacienteRecid.asstring);
end;

function TfrmPuntoVentaAdministracion.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmPuntoVentaAdministracion.Boton_Cobrar;
begin
...
procedure TfrmPuntoVentaAdministracion.Viejo_Cobrar;
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.CrearCobro;
Var
 qinsert    : TADOQuery;
...
procedure TfrmPuntoVentaAdministracion.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
...
procedure TfrmPuntoVentaAdministracion.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmPuntoVentaAdministracion.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmPuntoVentaAdministracion.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmPuntoVentaAdministracion.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmPuntoVentaAdministracion.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaAdministracion.ActNotaCredito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
...
procedure TfrmPuntoVentaAdministracion.CrearNotaDebito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmPuntoVentaAdministracion.ActNotaDebito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
begin
 ...
 CrearTransCliente(qrEntradaPAcienteClienteId.value, 'NC', qfindcobro.FieldByName('ReciboNo').value, 'FT',
                   ...
                   qrEntradaPacienteMonedaId.Value);
//                   qrEntradaPAcienteEntredaId.value,qfindcobro.FieldByName('Fecha').value, ValorND * -1,
...
procedure TfrmPuntoVentaAdministracion.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaAdministracion.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntradaID.Value <> '' then
  begin
...
procedure TfrmPuntoVentaAdministracion.FacturaExterior1Click(Sender: TObject);
begin
 inherited;
 if qrEntradaPacienteEntradaID.Value <> '' then
   begin
...
procedure TfrmPuntoVentaAdministracion.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := recid;
  qrEntradaPaciente.Open;
...
procedure TfrmPuntoVentaAdministracion.RefrescarInterface;
begin
 actinterface;
...
// OJO - JUAN JOSE - BLOQUEADO PARA INTEGRARLO AL BOTON DE GUARDAR.   btcobrar.Enabled := false;
   ...
   If (qrEntradaPacienteCoberturaRechazada.Value = True) Or
      (qrEntradaPacienteCoberturaConfirmada.Value = True) Then
     ConfirmarCobertura1.Enabled := False;

   If (qrEntradaPacienteCoberturaRechazada.Value = False) And
      (qrEntradaPacienteCoberturaConfirmada.Value = False) Then
...
//     edcoberturaporc.Properties.ReadOnly := qrEntradaPacienteCoberturaConfirmada.Value;
     ...
     If (qrEntradaPacienteCoberturaRechazada.Value = True) then
      Begin
...
//Validando Los Parametros de Descuentos.
procedure TfrmPuntoVentaAdministracion.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
{
 If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoSeg.Value) Or
    (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoClinica.Value) Or
...
function TfrmPuntoVentaAdministracion.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmPuntoVentaAdministracion.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
 qfind := DM.Find('SELECT * FROM SysUsuarios WHERE UserID = :user',DM.CurUser);
...
procedure TfrmPuntoVentaAdministracion.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
 inherited;
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmPuntoVentaAdministracion.Act_Hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
//Eliminando Los Documentos en Hold.
procedure TfrmPuntoVentaAdministracion.Del_Hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmPuntoVentaAdministracion.No_Procesar;
Var
 qact : TADOQuery;
begin
{
...
procedure TfrmPuntoVentaAdministracion.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.Buscar_Muestra;
Var
 qfind  : TADOQuery;
 Dias   : Extended;
begin
...
procedure TfrmPuntoVentaAdministracion.Buscar_Combo;
begin
...
procedure TfrmPuntoVentaAdministracion.Insertar_Combo_Precio;
begin
...
procedure TfrmPuntoVentaAdministracion.Insertar_Combo_Blanco;
begin
 While Not qfindcombo.Eof Do
  Begin
   If (qrEntradaPacienteDetallePruebaID.Value = '') Or
...
//Actualizando los Datos del Cliente
procedure TfrmPuntoVentaAdministracion.Act_Cliente;
Var
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmPuntoVentaAdministracion.Buscar_Cliente;
begin
  ...
  If qfindCltParams.FieldByName('Principal').AsString <> '' then
    Begin
      ...
      If (qfindCltParams.FieldByName('UsarAcuerdoPropio').AsBoolean = True) then
        Begin
...
//          If (Operacion <> '') Then
          If qrEntradaPaciente.State in [dsInsert] Then
            Begin
              qrEntradaPacienteAcuerdoPropio.Value := True;
...
//          If (Operacion <> '') Then
          If qrEntradaPaciente.State in [dsInsert] Then
            Begin
              qrEntradaPacienteAcuerdoPropio.Value := False;
              qrEntradaPacienteClientePadre.Value := qfindCltParams.FieldByName('Principal').AsString;
            End;
        End;
    End
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmPuntoVentaAdministracion.Buscar_Paciente;
begin
...
//Buscando los Datos del Grupo del Cliente.
Procedure TfrmPuntoVentaAdministracion.Buscar_Grupo_Clt(Grupo: string);
begin
...
//Buscando los Datos del Grupo del Paciente.
Procedure TfrmPuntoVentaAdministracion.Buscar_Grupo_Pac(Grupo: string);
begin
...
procedure TfrmPuntoVentaAdministracion.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmPuntoVentaAdministracion.Insert_Card_Descuento;
...
procedure TfrmPuntoVentaAdministracion.ppHeaderBand3BeforePrint(Sender: TObject);
begin
  ...
  if (qrEntradaPacienteCoberturaConfirmada.Value = True) then
    LbCobertura.Caption := 'Cobertura Confirmada';

  if (qrEntradaPacienteCoberturaRechazada.Value = True) then
    LbCobertura.Caption := 'Cobertura Rechazada';

  If (qrEntradaPacienteCoberturaConfirmada.Value = False) And
     (qrEntradaPacienteCoberturaRechazada.Value = False) Then
    LbCobertura.Caption := 'No Se Ha Solicitado La Cobertura';
end;


procedure TfrmPuntoVentaAdministracion.ppSummaryFacturaSeguroBeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaAdministracion.ppSummaryBand4BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmPuntoVentaAdministracion.ppSummaryFactPacienteConSeguroBeforePrint(Sender: TObject);
begin
  inherited;
  Buscar_Cliente;
...
procedure TfrmPuntoVentaAdministracion.ppSummaryFactPacienteSinSeguroBeforePrint(Sender: TObject);
begin
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmPuntoVentaAdministracion.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaAdministracion.ppDetailBand4BeforePrint(Sender: TObject);
begin
...
procedure TfrmPuntoVentaAdministracion.ppDetailBandSinSeguroBeforePrint(Sender: TObject);
begin
  qfindprint := DM.find('SELECT * FROM PTPrueba WHERE PruebaID = :pru', qrEntradaPacienteDetallePruebaId.Value);
...
procedure TfrmPuntoVentaAdministracion.InsertarMaterialesDefault;
Var
...
procedure TfrmPuntoVentaAdministracion.InsertarMaterialesPrueba;
Var
 qfind, qinsert : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmPuntoVentaAdministracion.Buscar_Labels(muestra: String; prueba: String): Boolean;
Var
 qfind : TADOQuery;
 valor : Boolean;
begin
...
procedure TfrmPuntoVentaAdministracion.CrearLabels(SecAct: Integer);
var
...
procedure TfrmPuntoVentaAdministracion.InsertarLabel;
var
 Qinsert    : TADOQuery;
 labelrecid : Integer;
begin
...
procedure TfrmPuntoVentaAdministracion.ImprimirLabel;
var
 qfind  : TADOQuery;
 texto  : TextFile;
 cadena : String;
...
//Calculando el Nuevo Precio de la Prueba Dependiendo del Cliente Actual.
procedure TfrmPuntoVentaAdministracion.Confirmar_Precio_Prueba;
var
 qprueba : TADOQuery;
begin
  inherited;
   ...
   Else
     Begin
       If (qprueba.FieldByName('Tipo').Value = 'C') then
         Begin
           If (qprueba.FieldByName('FacturarCabecera').Value = True) then
             Begin
               //Registrando la Cabecera de los Combos (CON PRECIO).
               qrEntradaPacienteDetalleRefRecid.Value := qrEntradaPacienteRecId.Value;
               qrEntradaPacienteDetalleRepMuestra.Value := qrEntradaPacienteRepMuestra.Value;
...
procedure TfrmPuntoVentaAdministracion.Procesar_Usuario;
Var
  Valor : Boolean;
  Pass2, Clave : Integer;
...
Function TfrmPuntoVentaAdministracion.Crear_Clave(cedularnc : String) : Integer;
Var
  Numero  : Double;
  Valor   : Int64;
//  Valor   : Integer;
...
//Creando el Usuario de Internet.
Function TfrmPuntoVentaAdministracion.Crear_Usuario(nombre : String) : String;
Var
  Texto : String;
...
Function TfrmPuntoVentaAdministracion.Valida_Usuario(usuario : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
...
procedure TfrmPuntoVentaAdministracion.Insertar_Usuario(usuario: string; clave: string; name: string; cedula: string;
...
//Validando la Existencia del Usuario Creado.
Function TfrmPuntoVentaAdministracion.Buscar_User_Internet(Cliente : String) : Boolean;
Var
 qfind  : TAdoQuery;
begin
...
function TfrmPuntoVentaAdministracion.BuscarDia(dia: Integer) : Integer;
Var
 valor : Integer;
begin
 valor := 0;
...
function TfrmPuntoVentaAdministracion.FechaPrometida(Prueba: string) : TDate;
Var
 fecha : TDate;
 qtest : TADOQuery;
 qfrec : TADOQuery;
...
procedure TfrmPuntoVentaAdministracion.Agregar_Pacientes(PacienteId : String);
Var
 sqlString : String;
...
//    ( qrEntradaPacientePacienteID.IsNull ) Then
  Begin
   ...
   sqlString := 'SELECT * FROM PTCliente WHERE GrupoCliente IN (' + #39 +
                 DM.qrParametroGrupoPriv.Value + #39 + ',' + #39 +
                 DM.qrParametroGrupoEmp.Value + #39 + ') '+
   ...
   If (DM.qrPacientes.RecordCount > 0) Then
    Begin
      ...
      If (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoSeg.Value) then
        begin
          If (DM.qrPacientesCobrarDiferencia.Value = True) then
            EliminarDescuentoAplicado1Click(Nil);
        end;
