...
type
  TfrmCargaPlanCia2 = class(TfrmCustomModule)
...
var
  frmCargaPlanCia2   : TfrmCargaPlanCia2;
...
function TfrmCargaPlanCia2.ValidateCliente : Boolean;
var
 qfind : TADOQuery;
 ret : Boolean;
begin
...
procedure TfrmCargaPlanCia2.CrearTransCliente(cliente: string; tipodoc: string; documento: string;
tipoaplica: string; documentoaplica: string;fecha : TDateTime; valor: Double;moneda :string);
var
 qinsert : TADOQuery;
begin
...
procedure TfrmCargaPlanCia2.CuadredeCaja1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(1402);
end;

procedure TfrmCargaPlanCia2.CuadredeCaja2Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7987);
end;

procedure TfrmCargaPlanCia2.RefrescarGrid(SoloLectura: Boolean);
begin
...
procedure TfrmCargaPlanCia2.ActInterface;
begin
 act_hold;
 Val_Descuento;
...
procedure TfrmCargaPlanCia2.ImpresionRecibo;
begin
...
procedure TfrmCargaPlanCia2.ImpresionNC;
begin
  DM.qrCobro.Close;
  DM.qrCobro.Parameters[0].Value := cobroid;
  DM.qrCobro.Open;
...
procedure TfrmCargaPlanCia2.CambiarLaboratorioNoenlasLineas1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.CancelarCobro;
begin
...
function TfrmCargaPlanCia2.GetMuestraNo : String;
begin
  result := GetNextSecDoc('MT');
end;

function TfrmCargaPlanCia2.GetReciboNo : String;
begin
  result := GetNextSecDoc('RI');
end;

function TfrmCargaPlanCia2.GetNotaCredito : String;
begin
  result := GetNextSecDoc('NC');
end;

procedure TfrmCargaPlanCia2.ActDetalle;
var
 bM : TBookMark;
 qact : TADOQuery;
begin
...
function TfrmCargaPlanCia2.ImporteBrutoExclLineaActual(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmCargaPlanCia2.ImporteBrutoExclLineaActualAndCobertura(refrecid : integer ;secuencia : integer) : Double;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmCargaPlanCia2.TotalDescuentoLinea : Double;
var
...
function TfrmCargaPlanCia2.ImporteLinea : Double;
Var
...
function TfrmCargaPlanCia2.CoberturaAplicada : Double;
var
...
procedure TfrmCargaPlanCia2.ConfirmarCobertura1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7993);
end;

procedure TfrmCargaPlanCia2.btcancelarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.btclienteClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteCoberturaConfirmada.Value then
...
procedure TfrmCargaPlanCia2.bteliminarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.btentradaClick(Sender: TObject);
var
 continuar : Boolean;
begin
  inherited;
...
procedure TfrmCargaPlanCia2.btgrabarClick(Sender: TObject);
var
...
procedure TfrmCargaPlanCia2.BtHoldClick(Sender: TObject);
begin
 inherited;
  if ValidateRecord(dsEntradaPaciente.DataSet) and ValidateCliente then
   begin
...
procedure TfrmCargaPlanCia2.btimpcotClick(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmCargaPlanCia2.btnotacreditoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.btpacienteClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.btpruebaClick(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7998);
end;

procedure TfrmCargaPlanCia2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.FormCreate(Sender: TObject);
begin
...
procedure TfrmCargaPlanCia2.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.SetColorTo(iColor: TColor);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmCargaPlanCia2.SetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmCargaPlanCia2.SetComponentReadOnly(thisComponent: TComponent; bFlag : Boolean);
var
  i : Integer;
  oColor : TColor;
begin
...
procedure TfrmCargaPlanCia2.UnSetReadOnlyToNoEdit;
var
  i : Integer;
begin
  for i := 0 to ComponentCount - 1 do begin
...
procedure TfrmCargaPlanCia2.NotadeCredito1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaConsulta(-7991,qrEntradaPacienteRecid.asstring);
end;

procedure TfrmCargaPlanCia2.NuevaVenta;
begin
  cobroid := '';
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteAfterPost(DataSet: TDataSet);
var
 qdelete : TADOQuery;
 tipodoc : string;
begin
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteCalcFields(DataSet: TDataSet);
begin
  inherited;
  qrEntradaPacienteTotalPendiente.Value := qrEntradaPacienteNeto.Value - qrEntradaPacienteTotalPagado.Value;
end;

procedure TfrmCargaPlanCia2.qrEntradaPacienteCoberturaExpPorcValidate(
  Sender: TField);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteCoberturaPorcValidate(Sender: TField);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteCoberturaValorValidate(
  Sender: TField);
begin
  inherited;
{  if (qrEntradaPacienteCoberturaValor.Value >= 100) and
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleAfterDelete(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
end;

procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleAfterPost(DataSet: TDataSet);
begin
  inherited;
  ActTotales;
...
procedure TfrmCargaPlanCia2.VerificarPagoDiferencia;
var
 qfind : TADOQuery;
begin
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
  if qrEntradaPacienteDetalleCoberturaAplica.value then
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleBeforeEdit(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleBeforeInsert(DataSet: TDataSet);
begin
  inherited;
    comboprecio := True;
end;

procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetalleDescuentoChange(
  Sender: TField);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetallePruebaIDChange(Sender: TField);
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDetallePruebaIDValidate(Sender: TField);
begin
  inherited;
    Begin
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteDoctorIDChange(Sender: TField);
begin
  inherited;
//  Buscar_Doctor;
end;

procedure TfrmCargaPlanCia2.EdDoctorPropertiesChange(Sender: TObject);
begin
  inherited;
  Buscar_Doctor;
end;

procedure TfrmCargaPlanCia2.Buscar_Doctor;
var
 qfind : TADOQuery;
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteNombrePacienteValidate(
  Sender: TField);
begin
  inherited;
  if (qrEntradaPacienteOrigen.Value = DM.qrParametroGrupoLab.Value) then
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteOrigenChange(Sender: TField);
begin
  inherited;
  actinterface;
end;

procedure TfrmCargaPlanCia2.qrEntradaPacienteTipoDocumentoChange(Sender: TField);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.qrEntradaPacienteTipoEntradaChange(Sender: TField);
begin
  inherited;
...
function TfrmCargaPlanCia2.MaxSecuenciaLinea : Integer;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmCargaPlanCia2.MenuItem1Click(Sender: TObject);
begin
  inherited;
  frmMain.LanzaVentana(-7988);
end;

procedure TfrmCargaPlanCia2.ActTotales;
Var
 qfind : TADOQuery;
begin
 ActDetalle;
...
procedure TfrmCargaPlanCia2.AsignarDescuentoAutorizadoporCobros1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.AsignarDescuentoPermitidoalUsuario1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.RecalcularLineas;
begin
...
procedure TfrmCargaPlanCia2.RecibodeCobro1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.EliminarDescuentoAplicado1Click(Sender: TObject);
begin
  inherited;
  qrEntradaPacienteDescuentoPorc.Value := 0;
  qrEntradaPacienteDescuentoValor.Value := 0;
...
function TfrmCargaPlanCia2.ExisteCobro : Boolean;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
function TfrmCargaPlanCia2.TipoCobro : String;
Var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmCargaPlanCia2.DesabilitarBotones(_SiNo : Boolean);
begin
...
procedure TfrmCargaPlanCia2.edcoberturavalorExit(Sender: TObject);
begin
  inherited;
  if qrEntradaPaciente.State in [dsedit,dsinsert] then
  begin
...
function TfrmCargaPlanCia2.GetNextSecDoc(tipodoc : string) : String;
var
 qsecdoc : TADOQuery;
begin
 qsecdoc := DM.NewQuery;
...
procedure TfrmCargaPlanCia2.GastosVarios1Click(Sender: TObject);
begin
  inherited;
  frmMain.lanzaConsulta(-7984,qrEntradaPacienteRecid.asstring);
end;

function TfrmCargaPlanCia2.GetEntradaID : String;
begin
 DM.qrParametro.Close;
 DM.qrParametro.Open;
...
procedure TfrmCargaPlanCia2.btcobrarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.CrearCobro;
Var
 qinsert    : TADOQuery;
...
procedure TfrmCargaPlanCia2.RefrescarCobro;
Var
 qfind : TADOQuery;
begin
...
procedure TfrmCargaPlanCia2.ActCobro;
Var
 qupdate    : TADOquery;
 qfind      : TADOQuery;
...
Function TfrmCargaPlanCia2.buscar_valores;
Var
  valor : Boolean;
begin
  valor := True;
...
procedure TfrmCargaPlanCia2.correccion;
begin
  mdPago.First;
  While Not mdPago.Eof do
   Begin
...
function TfrmCargaPlanCia2.ValidarMontoCobrado : Boolean;
Var
 monto : Double;
begin
 monto := 0;
...
procedure TfrmCargaPlanCia2.CrearNotaCredito;
Var
 qinsert : TADOQuery;
begin
 DM.qrParametro.Close;
...
procedure TfrmCargaPlanCia2.ActNotaCredito;
Var
 qupdate : TADOquery;
 qfind : TADOQuery;
 qfindcobro : TADoQuery;
...
procedure TfrmCargaPlanCia2.VolantedePruebasARS1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmCargaPlanCia2.VolantedePruebasTomaMuestra1Click(Sender: TObject);
begin
  inherited;
  if qrEntradaPacienteEntredaID.Value <> '' then
  begin
...
procedure TfrmCargaPlanCia2.BuscarDatos;
begin
  qrEntradaPaciente.Close;
  qrEntradaPaciente.parameters[0].Value := recid;
  qrEntradaPaciente.Open;
...
procedure TfrmCargaPlanCia2.RefrescarInterface;
begin
  actinterface;
...
//Validando Los Parametros de Descuentos.
procedure TfrmCargaPlanCia2.Val_Descuento;
begin
 //Buscando los Datos del Cliente a Facturar y Sus Parametros.
 Buscar_Cliente;
{
...
function TfrmCargaPlanCia2.CanCambiarLaboratorio;
var
 qfind : TADOQuery;
begin
...
function TfrmCargaPlanCia2.Asignar_Descuento;
var
 qfind : TADOQuery;
begin
 qfind := DM.Find('Select * from SysUsuarios Where UserID = :user', DM.CurUser);
...
procedure TfrmCargaPlanCia2.RegistrarPruebadelExterior1Click(Sender: TObject);
begin
 inherited;
  DM.qrParametro.Close;
  DM.qrParametro.Open;
...
procedure TfrmCargaPlanCia2.act_hold;
var
 qfind : TADOQuery;
begin
 qfind := DM.NewQuery;
...
procedure TfrmCargaPlanCia2.Asignar2daMuestra1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.Buscar_Muestra;
Var
 qfind  : TADOQuery;
 Dias   : Extended;
begin
...
procedure TfrmCargaPlanCia2.Buscar_Combo;
begin
...
procedure TfrmCargaPlanCia2.Insertar_Combo_Precio;
begin
...
procedure TfrmCargaPlanCia2.Insertar_Combo_Blanco;
begin
  While Not qfindcombo.Eof Do
    Begin
      qrEntradaPacienteDetalle.Post;
...
//Actualizando los Datos del Cliente (Poliza - Aseguradora).
procedure TfrmCargaPlanCia2.Act_Seguro_Cliente;
Var
...
//Buscando los Datos del Cliente a Facturar y Sus Parametros.
procedure TfrmCargaPlanCia2.Buscar_Cliente;
begin
...
//Buscando los Datos del PACIENTE Registrado y Sus Parametros.
procedure TfrmCargaPlanCia2.Buscar_Paciente;
begin
...
procedure TfrmCargaPlanCia2.Buscar_Cod_Cups(cliente: String; prueba: String);
begin
...
//Insertando Los Datos de la Tarjeta de Descuento.
procedure TfrmCargaPlanCia2.Insert_Card_Descuento;
...
procedure TfrmCargaPlanCia2.ppHeaderBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  inherited;
  //Buscando los Datos del Cliente.
  Buscar_Cliente;
...
procedure TfrmCargaPlanCia2.ppDetailBand3BeforePrint(Sender: TObject);
begin
  inherited;
...
procedure TfrmCargaPlanCia2.ppDetailBand5BeforePrint(Sender: TObject);
begin
  inherited;
  ...
  If (qfindCltParams.FieldByName('ImprimirAliasPrueba').AsBoolean = True) Then
    Begin
      ...
      LbDescripcion2.Caption := qfindprint.FieldByName('Alias').AsString;
    end
  Else
    Begin
      LbDescripcion1.Caption := qrEntradaPacienteDetalleDescripcion.Value;
      LbDescripcion2.Caption := qrEntradaPacienteDetalleDescripcion.Value;
    end;
  ...
  If (qfindCltParams.FieldByName('IncluirPrecioTicket').AsBoolean = True) Then
    Begin
      ...
      LbPrecio2.Caption := FormatFloat('##,###,##0.00', qrEntradaPacienteDetallePrecio.Value);
    end
  Else
    Begin
      LbPrecio1.Caption := '';
      LbPrecio2.Caption := '';
      LbNetoTit.Visible := False;
      LbPagadoTit.Visible := False;
      LbPendienteTit.Visible := False;
    end;
end;
...
{
//Factura de la Cia. de Seguros. (PROGRAMAR EL CODIGO CUPS)
ppImpFacturaSeguro.Print;

//Factura del Paciente CON Seguro. DEJAR IGUAL POR AHORA PERO HAY QUE: (PROGRAMAR LOS PARAMETROS DE CLIENTES)
ppImpFactPacienteConSeguro.Print;

//Factura del Paciente SIN Seguro. (PROGRAMAR LOS PARAMETROS DE CLIENTES)
ppImpFactPacienteSinSeguro.Print;
}
