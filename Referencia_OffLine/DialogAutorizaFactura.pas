...
type
  TfrmAutorizaFacturaPend = class(TfrmDialogModule)
...
var
  frmAutorizaFacturaPend: TfrmAutorizaFacturaPend;
...
procedure TfrmAutorizaFacturaPend.Cargar;
begin
  EdUsuario.Text := '';
  edhora.Time := Time;
...
procedure TfrmAutorizaFacturaPend.FormKeyDown(Sender: TObject;
...
procedure TfrmAutorizaFacturaPend.Run;
begin
 Cargar;
...
procedure TfrmAutorizaFacturaPend.VerificarUsuario;
Var
 clave  : String;
 qfind  : TADOQuery;
begin
