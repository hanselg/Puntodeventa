...
type
  TInterfaseAS400 = class(TDataModule)
    ...
    ADOQuery2: TADOQuery;
    Timer1: TTimer;
    qrASEncabezadoGen: TADOQuery;
    qrASEncabezadoGenIN3MUE: TBCDField;
    qrASEncabezadoGenIN3NOM: TStringField;
    qrASEncabezadoGenIN3HOR: TIntegerField;
    qrASEncabezadoGenIN3DIR: TStringField;
    qrASEncabezadoGenIN3EDA: TIntegerField;
    qrASEncabezadoGenIN3NAC: TIntegerField;
    qrASEncabezadoGenIN3TEL: TStringField;
    qrASEncabezadoGenIN3CAT: TStringField;
    qrASEncabezadoGenIN3FEC: TIntegerField;
    qrASEncabezadoGenIN3USU: TStringField;
    qrASEncabezadoGenIN3SEX: TStringField;
    qrASEncabezadoGenIN3CED: TBCDField;
    qrASEncabezadoGenIN3SUC: TIntegerField;
    qrASEncabezadoGenIN3CDO: TIntegerField;
    qrASEncabezadoGenIN3DOC: TStringField;
    qrASEncabezadoGenIN3CLI: TBCDField;
    qrASEncabezadoGenIN3FAC: TBCDField;
    qrASEncabezadoGenIN3PAG: TBCDField;
    qrASEncabezadoGenIN3RES: TBCDField;
    qrASEncabezadoGenIN3EPA: TIntegerField;
    qrASEncabezadoGenIN3IPA: TIntegerField;
    qrASEncabezadoGenIN3EDO: TIntegerField;
    qrASEncabezadoGenIN3IDO: TIntegerField;
    qrASEncabezadoGenIN3RCL: TIntegerField;
    qrASEncabezadoGenIN3ICL: TIntegerField;
    qrASEncabezadoGenIN3COM: TStringField;
    qrASEncabezadoGenIN3ABR: TIntegerField;
    qrASEncabezadoGenIN3REL: TBCDField;
    qrASEncabezadoGenIN3REF: TStringField;
    qrASEncabezadoGenIN3ACT: TStringField;
    qrASEncabezadoGenIN3TAS: TBCDField;
    qrASEncabezadoGenIN3FPA: TBCDField;
    qrASEncabezadoGenIN3POL: TStringField;
    qrASEncabezadoGenIN3TAR: TBCDField;
    qrASEncabezadoGenIN3MON: TIntegerField;
    qrASEncabezadoGenIN3CAM: TBCDField;
    qrASEncabezadoGenIN3ENV: TBCDField;
    qrASEncabezadoGenIN3SEG: TBCDField;
    qrASEncabezadoGenIN3NRE: TIntegerField;
    qrASEncabezadoGenIN3URG: TIntegerField;
    qrASEncabezadoGenIN3CCO: TStringField;
    qrASEncabezadoGenIN3ORI: TStringField;
    qrASEncabezadoGenIN3EMB: TStringField;
    qrASEncabezadoGenIN3PNA: TStringField;
    qrASEncabezadoGenIN3NUP: TIntegerField;
    qrASEncabezadoGenIN3PAS: TStringField;
    qrASEncabezadoGenIN3DTO: TStringField;
    qrASEncabezadoGenIN3NAP: TStringField;
    qrASEncabezadoGenIN3PAP: TStringField;
    qrASEncabezadoGenIN3DI2: TStringField;
    qrASEncabezadoGenIN3IND: TStringField;
    qrASEncabezadoGenIN3RAU: TStringField;
    qrASDetalleGen: TADOQuery;
    qrASDetalleLec: TADOQuery;
    ...
    qrASDetalleGenIN4MUE: TBCDField;
    qrASDetalleGenIN4COD: TIntegerField;
    qrASDetalleGenIN4NOM: TStringField;
    qrASDetalleGenIN4STS: TStringField;
    qrASDetalleGenIN4DEP: TIntegerField;
    qrASDetalleGenIN4FEC: TIntegerField;
    qrASDetalleGenIN4HOR: TIntegerField;
    qrASDetalleGenIN4USU: TStringField;
    qrASDetalleGenIN4COM: TStringField;
    qrASDetalleGenIN4PET: TIntegerField;
    qrASDetalleGenIN4ANT: TBCDField;
    qrASDetalleGenIN4VAL: TBCDField;
    qrASDetalleGenIN4TIP: TStringField;
    qrASDetalleGenIN4ACT: TStringField;
    qrASDetalleGenIN4GRU: TStringField;
  ...
  public
    ...
    Procedure MandarPruebaAS4000(MuestraNo: string; Paciente: String);
...
procedure TInterfaseAS400.MandarPruebaAS4000(MuestraNo: String; Paciente: String);
Var
  _tipo       : String;
  _blanks     : String;
  _record     : Integer;
...
//  SetEncabezado(qrSQLEncabezadoMuestraNo.AsInteger,               //  qrSQLEncabezadoMuestra
  SetEncabezadoGen(qrSQLEncabezadoMuestraNo.AsString,                //  qrSQLEncabezadoMuestra
                qrSQLEncabezadoNombrePaciente.AsString,
                qrSQLEncabezadoHora.AsInteger,
                qrSQLEncabezadoDireccion.AsString,
                qrSQLEncabezadoEdadPaciente.AsString,             //  qrSQLEncabezadoEdadCalculada
  ...
  While Not qrSQLDetalle.Eof Do
   Begin
    If (no_insurance = True) or (No_Seguro ='S') Then
     ...
     InterfaseAS400.SetDetalleGen(qrSQLDetalleMuestraNo.AsString,           //  qrSQLDetalleMuestra
                               qrSQLDetalleCodigoAS400.AsInteger,         //  qrSQLDetallePruebaId
                               qrSQLDetalleNombrePrueba.AsString,
                               qrSQLDetalleStatusPrueba.AsString,
                               qrSQLDetalleFechaEntradaTexto.AsInteger,   //  qrSQLDetalleFechaEntrada
...
Procedure TInterfaseAS400.SetDetalleGen(Muestra: String; CodigoPrueba: Integer; Prueba: String;
                                     Status: String; FechaEntrada: Integer; Hora: Integer; Usuario: String;
                                     Comentario: String; Peticion2Muestra: Integer; Valor: Currency;
                                     Depto: Integer = 0; NumeroMuestraAnterior: Integer = 0;
                                     TipoMuestra: String = '';GrupoPruebaID: String = '';
...
begin
  if (CodigoPrueba > 0) then
    Begin
      qrASDetalleGEN.Close;
      qrASDetalleGEN.SQL.Text := 'SELECT * FROM INP044WI WHERE (IN4MUE='+#39+Muestra+#39+') AND (IN4COD = '+intToStr(CodigoPrueba)+')';
      qrASDetalleGEN.Open;

      _record := qrASDetalleGEN.RecordCount;

      If qrASDetalleGEN.Eof Then
        qrASDetalleGEN.Insert
      Else
        qrASDetalleGEN.Edit;
...
////////////////////////////////////////////////////////////////////////////////
      qrASDetalleGENIN4MUE.AsString   := FormatFloat('00000000000', StrToFloat(Muestra));
      qrASDetalleGENIN4COD.AsString   := FormatFloat('0000', CodigoPrueba);
      qrASDetalleGENIN4NOM.AsString   := Trim(LeftStr(Prueba, 50));
      qrASDetalleGENIN4STS.AsString   := LeftStr(Status, 1);
      qrASDetalleGENIN4DEP.AsString   := FormatFloat('000', Depto);
      qrASDetalleGENIN4FEC.AsInteger  := FechaEntrada;
      qrASDetalleGENIN4HOR.AsString   := FormatFloat('0000000', Hora);
      qrASDetalleGENIN4USU.AsString   := LeftStr(Usuario, 10);
      qrASDetalleGENIN4COM.AsString   := Trim(LeftStr(Comentario, 100));
      qrASDetalleGENIN4PET.AsInteger  := Peticion2Muestra;
      qrASDetalleGENIN4ANT.AsString   := FormatFloat('00000000000', NumeroMuestraAnterior);
      qrASDetalleGENIN4TIP.AsString   := LeftStr(TipoMuestra, 1);
      qrASDetalleGENIN4VAL.AsCurrency := DM.Redondeo(Valor);
      qrASDetalleGENIN4GRU.AsString   := LeftStr(GrupoPruebaID, 3);
...
Procedure TInterfaseAS400.SetEncabezadoGen(Muestra: String; Nombre: String; Hora: Integer; Direccion: String;
                                        Edad: String; FechaNacimieto: Integer; Categoria: String;
                                        Fecha: Integer; Usuario: String; Sexo: String; Sucursal: Integer;
                                        Doctor: String; Cliente: String; CodigoIdAS400: String; Facturado: Currency;
                                        Pagado: Currency; Resto: Currency; TipoResultadoPaciente: Integer; InternetPaciente: Integer;
...
begin
  ...
  qrASEncabezadoGEN.Close;
  qrASEncabezadoGEN.SQL.Text := 'SELECT * FROM INP033WI WHERE ( IN3MUE ='+#39+Muestra+#39+')';
  qrASEncabezadoGEN.Open;

  _record := qrASEncabezadoGEN.RecordCount;

  If qrASEncabezadoGEN.Eof then
    qrASEncabezadoGEN.Insert
  else
  begin
    qrASEncabezadoGEN.Delete;
    qrASEncabezadoGEN.Insert;
  end;
...
///
  if (Estatus = 0) Or (Estatus = 2) then
     qrASEncabezadoGENIN3ACT.AsString     := ''
  else if Estatus = 1 then
     qrASEncabezadoGENIN3ACT.AsString     := 'C';

  If (No_Indicacion = True) Then
     qrASEncabezadoGENIN3IND.AsString     := '1'
  else
     qrASEncabezadoGENIN3IND.AsString     := '0';

  qrASEncabezadoGENIN3MUE.AsString     := FormatFloat('00000000000', StrToFloat(Muestra));
  qrASEncabezadoGENIN3NOM.AsString     := Trim(LeftStr(Nombre, 40));
  qrASEncabezadoGENIN3HOR.AsString     := FormatFloat('000000', Hora);
  if Length(Trim(Direccion)) < 41 then
  begin
     qrASEncabezadoGENIN3DIR.AsString     := Trim(LeftStr(Direccion, 40));
     qrASEncabezadoGENIN3DI2.AsString     := EmptyStr;
  end
  else If Length(Trim(Direccion)) > 40 then
  begin
     IntDir                         :=LastDelimiter(' ',Copy(Direccion,1,40));
     qrASEncabezadoGENIN3DIR.AsString  := Copy(Trim(Direccion),1,IntDir);
     qrASEncabezadoGENIN3DI2.AsString  := Copy(Trim(Direccion),IntDir+1,40);
  end;
  qrASEncabezadoGENIN3EDA.AsString     := FormatFloat('000', StrToInt(Edad));
  qrASEncabezadoGENIN3NAC.AsInteger    := Fechanacimieto;
  qrASEncabezadoGENIN3TEL.AsString     := Telefono;
  qrASEncabezadoGENIN3CAT.AsString     := Categoria;
  qrASEncabezadoGENIN3FEC.AsInteger    := Fecha;
  qrASEncabezadoGENIN3USU.AsString     := LeftStr(Usuario, 10);
  qrASEncabezadoGENIN3SEX.AsString     := LeftStr(Sexo, 1);
  qrAsEncabezadoGENIN3DTO.AsString     := IntToStr(Tipo_Doc);
  qrASEncabezadoGENIN3CED.AsString     := FormatFloat('00000000000', StrToFloat(Muestra));
  qrASEncabezadoGENIN3NUP.AsInteger    := Codigo_Tarjeta;
  qrASEncabezadoGENIN3SUC.AsString     := FormatFloat('0000', Sucursal);
  qrASEncabezadoGENIN3CDO.AsString     := FormatFloat('000000', StrToInt(CodigoDoctor));
  qrASEncabezadoGENIN3ORI.Asstring     := Area;
  qrASEncabezadoGENIN3DOC.AsString     := Doctor;

  If ( StrToFloat(CodigoIdAS400) > 0 ) then
  begin
    qrASEncabezadoGENIN3CLI.AsString     := FormatFloat('0000000000', StrToFloat(CodigoIdAS400))
  end
  Else
  Begin
      if Copy(cliente,1,1)='C' then
         ...
         sCli:=cliente;
      qrASEncabezadoGENIN3CLI.AsString     := FormatFloat('0000000000',StrToFloat(sCli))
  end;
  qrASEncabezadoGENIN3FAC.AsCurrency   := DM.Redondeo(Facturado);
  qrASEncabezadoGENIN3PAG.AsCurrency   := DM.Redondeo(Pagado);
  qrASEncabezadoGENIN3RES.AsCurrency   := DM.Redondeo(Resto);
  qrASEncabezadoGENIN3EPA.AsInteger    := TiporesultadoPaciente;
  qrASEncabezadoGENIN3IPA.AsInteger    := InternetPaciente;
  qrASEncabezadoGENIN3EDO.AsInteger    := TipoResultadoDoctor;
  qrASEncabezadoGENIN3IDO.AsInteger    := InternetDoctor;
  qrASEncabezadoGENIN3RCL.AsInteger    := TipoResultadoCliente;
  qrASEncabezadoGENIN3ICL.AsInteger    := InternetCliente;
  qrASEncabezadoGENIN3COM.AsString     := Trim(LeftStr(Comentario, 50));
  qrASEncabezadoGENIN3ABR.AsInteger    := PacienteClinica;
  qrASEncabezadoGENIN3REL.AsString     := FormatFloat('00000000000', NumeroRelacionInternet);
  qrASEncabezadoGENIN3REF.AsString     := Trim(LeftStr(ReferenciaExterna, 20));

  If ( DescuentoPorc > 0 ) Then
    qrASEncabezadoGENIN3TAS.AsCurrency := DM.Redondeo(DescuentoPorc);

  If ( CoberturaSeguro > 0 ) Then
  begin
    qrASEncabezadoGENIN3TAS.AsCurrency := DM.Redondeo(CoberturaPorc);
    qrASEncabezadoGENIN3SEG.AsCurrency := DM.Redondeo(CoberturaSeguro);
  end;

  qrASEncabezadoGENIN3FPA.AsCurrency   := DM.Redondeo(DiferenciaNeto);
  qrASEncabezadoGENIN3TAR.AsCurrency   := DM.Redondeo(TarjPago);

  If ( CoberturaSeguro > 1 ) Then
    qrASEncabezadoGENIN3POL.AsString     := LeftStr(ReferenciaExterna, 25)
  Else
    qrASEncabezadoGENIN3POL.AsString     := '0';

  qrASEncabezadoGENIN3MON.AsInteger  := StrToInt(Moneda);
  qrASEncabezadoGENIN3CAM.AsCurrency := DM.Redondeo(Tasa);
  qrASEncabezadoGENIN3ENV.AsCurrency := DM.Redondeo(GastoEnvio);

  if Cod_Caso <> 0 then
    qrASEncabezadoGENIN3NRE.AsInteger  := Cod_Caso
  else
    qrASEncabezadoGENIN3NRE.AsInteger  :=0;

  if Prioridad <> 0 then
    qrASEncabezadoGENIN3URG.AsInteger  := Prioridad
  else
    qrASEncabezadoGENIN3URG.AsInteger  :=0;

  if CConfirmada <> 'N' then
    qrASEncabezadoGENIN3CCO.AsString := CConfirmada
  else
    qrASEncabezadoGENIN3CCO.AsString := 'N';
  If (Embarazada = True) Then
    qrASEncabezadoGENIN3EMB.Value := '1'
  else
    qrASEncabezadoGENIN3EMB.Value := '0';

  qrASEncabezadoGENIN3PNA.AsString := Nacionalidad;
  qrASEncabezadoGENIN3NAP.AsString := AprobacionNo;
  qrASEncabezadoGENIN3PAP.AsString := AprobacionPor;
  qrASEncabezadoGEN.Post;
  qrASEncabezadoGEN.Close;
end;
...
begin
    ...
    Except
        Result:=False;
        FreeAndNil(qElimina);
        Raise exception.CreateFmt('Error Eliminado registro Base Intermedia INP03301 ó INP04401. Verifique', []);
    End;
    Result:=True;
    FreeAndNil(qElimina);
end;
