unit DatosUsuariosInternetDoctor;
...
type
  TfrmDatosUsuariosInternetDoctor = class(TfrmDatosModule)
    ...
    tvDatosActualizado: TcxGridDBColumn;
...
var
  frmDatosUsuariosInternetDoctor: TfrmDatosUsuariosInternetDoctor;
...
procedure TfrmDatosUsuariosInternetDoctor.BuscarData(codigo: string);
begin
...
procedure TfrmDatosUsuariosInternetDoctor.FormCreate(Sender: TObject);
begin
  inherited;
