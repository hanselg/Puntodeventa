inherited frmDatosCodigosCup: TfrmDatosCodigosCup
  ...
  object qrCodigosCup: TADOQuery
    ...
    object qrCodigosCupESTATUS: TIntegerField
      FieldName = 'ESTATUS'
    end
    object qrCodigosCupREFRECID: TIntegerField
      FieldName = 'REFRECID'
    end
    object qrCodigosCupDATAAREAID: TStringField
      FieldName = 'DATAAREAID'
      Size = 3
    end
    object qrCodigosCupRECID: TLargeintField
      FieldName = 'RECID'
    end
  end
end
