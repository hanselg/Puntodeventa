inherited frmTomaMuestras: TfrmTomaMuestras
  ...
  object qrEntradaPacienteDetalle: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT c.*,p.CondPaciente,p.CondMuestra,p.diasresultado,p.coddia' +
        'proc  '
      'FROM PTEntradaPacienteDetalle c, ptprueba p'
      'WHERE c.refrecid = :rec'
      'and c.pruebaid=p.pruebaid'
      'AND (c.TipoPrueba = '#39'P'#39' OR c.TipoPrueba = '#39'S'#39')'
      'And c.dataareaid='#39'ldr'#39' And p.dataareaid='#39'ldr'#39)
    Left = 424
    Top = 193
    ...
    object qrEntradaPacienteDetalleCondPaciente: TStringField
    ...
    object qrEntradaPacienteDetallecoddiaproc: TStringField
